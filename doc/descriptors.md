# Support for Output Descriptors in Kairyo Core

Since Kairyo Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `ryo1...` for mainnet or `tryo1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Kairyo's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Kairyo Core wallets, a convenience function `combo` is
