...
bech32_templates = [
  ...
  ('ryo',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('ryo',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('ryo',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tryo',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tryo',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tryo',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rryo',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rryo',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rryo', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tryo',  17, 32, False, False, False),
  ('rryo',  3,  1, False, False, False),
  ('ryo',   15, 41, False, False, False),
  ('tryo',  0, 16, False, False, False),
  ('rryo',  0, 32, True,  False, False),
  ('ryo',   0, 16, True,  False, False),
  ('tryo',  0, 32, False, True,  False),
  ('rryo',  0, 20, False, False, True)
]
