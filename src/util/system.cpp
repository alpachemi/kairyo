...
const char * const BITCOIN_CONF_FILENAME = "kairyo.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Kairyo";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Kairyo";
#else
    // Unix
    return pathRet / ".kairyo";
#endif
#endif
}
