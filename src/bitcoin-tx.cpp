...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " kairyo-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  kairyo-tx [options] <hex-tx> [commands]  Update hex-encoded kairyo transaction\n" +
            "or:     kairyo-tx [options] -create [commands]   Create hex-encoded kairyo transaction\n" +
            "\n";
