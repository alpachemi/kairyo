...
{
    const char* pszTimestamp = "Huffpost 12/apr/2021, George Floyd Had Exceptionally Strong Heart.";
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1618248194, 2084736230, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb78983a126cfde42b987c21245f2d94930d46dfbd1a0c29c145ab6f68a4ebc3d"));
        assert(genesis.hashMerkleRoot == uint256S("0x92422cf60dafc6f984a1867e6ab3264920a06f92861f6c51a7bd12476ba5f7d1"));
        ...
        /*
		vSeeds.emplace_back("seed-a.kairyo.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.kairyotools.com");
        vSeeds.emplace_back("dnsseed.kairyopool.org");
		*/
        ...
        checkpointData = {
            {
                {  0, uint256S("0xb78983a126cfde42b987c21245f2d94930d46dfbd1a0c29c145ab6f68a4ebc3d")},
            }
        };
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.kairyotools.com");
        vSeeds.emplace_back("seed-b.kairyo.loshan.co.uk");
