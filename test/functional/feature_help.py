...
"""Verify that starting kairyo with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kairyo with -h for help text")
        ...
        self.log.info("Start kairyo with -version for version information")
        ...
        self.log.info("Start kairyod with -fakearg to make sure it does not start")
